...
export default function Dashboard() {
    ...
    const startDetection = async () => {
        try {
            ...
            if (videoRef.current) {
                ...
                setSessionData([]); // Clear previous session
                setIsRunning(true);
            }
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-slate-200 flex flex-col font-inter selection:bg-[#00ff88]/30">
            ...
            {/* Main Content */}
            <main className="flex-1 p-6 lg:p-10 max-w-[1600px] mx-auto w-full grid grid-cols-1 xl:grid-cols-4 gap-8 z-10">
                ...
                <div className="xl:col-span-3 order-1 xl:order-2">
                    <div className="bg-[#1e293b]/40 backdrop-blur-2xl rounded-[3rem] border border-white/5 shadow-2xl overflow-hidden flex flex-col h-full max-h-[85vh] relative flex-1">
                        ...
                        <div className="flex-1 relative bg-[#020617] p-4 flex items-center justify-center min-h-[400px]">
                            <video ref={videoRef} autoPlay playsInline suppressHydrationWarning className="absolute opacity-0 pointer-events-none" />
                            ...
                            {/* Optimization Canvas */}
                            <canvas ref={captureCanvasRef} width={320} height={180} className="hidden" />
                        </div>
